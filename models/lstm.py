...
def run_lstm_pipeline(ticker: str, scaled_dir: str, model_dir: str, start_date: str, end_date: str, time_steps: int = 10):  # Definește funcția principală, setând implicit 'time_steps' la 10 zile (memoria LSTM-ului).
    ...
    input_file_path = os.path.join(scaled_dir, file_name)  # Creează calea completă, îmbinând numele folderului sursă cu fișierul.
