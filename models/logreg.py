...
def run_logreg_pipeline(ticker: str, input_dir: str, model_dir: str, start_date: str, end_date: str):  # Definește funcția pipeline cu parametrii de configurare necesari, specificând tipurile de date.
    """
    ...
    input_file_path = os.path.join(input_dir, file_name)  # Formează calea absolută sau relativă completă către fișierul CSV cu feature-urile deja procesate.
