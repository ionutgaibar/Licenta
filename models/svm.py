...
def run_svm_pipeline(ticker: str, scaled_dir: str, model_dir: str, start_date: str, end_date: str):  # Definește funcția pipeline cu parametrii necesari (simbol, directoare, date).
    ...
    input_file_path = os.path.join(scaled_dir, file_name)  # Combină directorul de intrare cu numele fișierului pentru a obține calea completă.
